            ...
            while (false !== ($file = readdir($handle))) {
                if (strlen($file) > 5 && substr($file, -5) === '.json') {
                    if (!is_readable($dir.$file)) {
                        $ret[] = array('ERRMES' => Translator::getInstance()->trans('Can\'t read file'), 'ERRFILE' => 'Paybox/Config/' . $file);
                    }
                    if (!is_writable($dir.$file)) {
                        $ret[] = array('ERRMES' => Translator::getInstance()->trans('Can\'t write file'), 'ERRFILE' => 'Paybox/Config/' . $file);
                    }
                }
            }
        }
